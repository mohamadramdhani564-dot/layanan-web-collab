...
<p>Total Service</p></div><div class="icon"><i class="fas fa-tools"></i></div></div></div>

<div class="col-lg-3 col-6">
<div class="small-box bg-success"><div class="inner">
<h3>Rp <?=number_format($stat['total_pendapatan'],0,",",".")?></h3>
<p>Total Pendapatan</p></div><div class="icon"><i class="fas fa-money-bill-wave"></i></div></div></div>

<div class="col-lg-3 col-6">
<div class="small-box bg-warning"><div class="inner">
<h3><?=number_format($stat['service_hari_ini'])?></h3>
<p>Service Hari Ini</p></div><div class="icon"><i class="fas fa-calendar-day"></i></div></div></div>

<div class="col-lg-3 col-6">
<div class="small-box bg-danger"><div class="inner">
<h3>Rp <?=number_format($stat['rata_biaya'],0,",",".")?></h3>
<p>Rata-rata Biaya</p></div><div class="icon"><i class="fas fa-chart-line"></i></div></div></div>
</div>
...
<a href="laporan_service.php" class="btn btn-secondary">Reset</a>
...
<div class="card">
<div class="card-header"><h3 class="card-title">Data Service</h3></div>
<div class="card-body table-responsive">
<table class="table table-bordered table-hover" id="example1">
<thead>
<tr>
<th>No</th><th>Tanggal</th><th>Nota</th><th>Pelanggan</th><th>Merk</th><th>Tahun</th><th>Transmisi</th><th>Plat</th><th>Keterangan</th><th>Biaya</th>
</tr>
</thead>
<tbody>
<?php $no=1;$grand=0; while($d=mysqli_fetch_assoc($data)){ $grand+=$d['harga']; ?>
<tr>
<td><?=$no++?></td>
